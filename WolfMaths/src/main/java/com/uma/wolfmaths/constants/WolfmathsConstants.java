package com.uma.wolfmaths.constants;

public final class WolfmathsConstants {
	
	public static final String API_RESULT_SEPARATOR = "&%";
	public static final String APP_STEP_1 = "step1";
	public static final String APP_STEP_2 = "step2";
	public static final String APP_STEP_3 = "step3";
	public static final String APP_STEP_4 = "step4";
	public static final String APP_VARIABLE_X = "varX";
